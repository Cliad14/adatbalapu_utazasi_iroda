...
--LEGITARSASAGOK
INSERT INTO LEGITARSASAG VALUES('L�ggit�rsas�g Zrt.', 'Rep�l� R�bert', 'P�pa');
INSERT INTO LEGITARSASAG VALUES('Csak felfel� Rt.', 'Sz�ll� Szil�rd', 'Boba');
INSERT INTO LEGITARSASAG VALUES('Turbina Rt.', 'Amelia Earhart', 'Szeged');
INSERT INTO LEGITARSASAG VALUES('Lufthansa', 'Grippen Gerg�', 'Sz�kesfeh�rv�r');
INSERT INTO LEGITARSASAG VALUES('Boeing �s t�rsa', 'Boeing B�lint', 'Budapest');


--JARATOK
INSERT INTO JARAT VALUES(1001, 0, 10, TO_TIMESTAMP('2022 01 01 12:30:00','YYYY MM DD HH24:MI:SS'), TO_TIMESTAMP('2022 01 01 17:30:00','YYYY MM DD HH24:MI:SS'), 'Turbina Rt.');
INSERT INTO JARAT VALUES(1002, 0, 20, TO_TIMESTAMP('2022 01 01 12:30:00','YYYY MM DD HH24:MI:SS'), TO_TIMESTAMP('2022 01 01 17:30:00','YYYY MM DD HH24:MI:SS'), 'Turbina Rt.');
INSERT INTO JARAT VALUES(1003, 0, 14, TO_TIMESTAMP('2022 01 01 12:30:00','YYYY MM DD HH24:MI:SS'), TO_TIMESTAMP('2022 01 01 17:30:00','YYYY MM DD HH24:MI:SS'), 'Turbina Rt.');
INSERT INTO JARAT VALUES(1004, 0, 45, TO_TIMESTAMP('2022 01 01 12:30:00','YYYY MM DD HH24:MI:SS'), TO_TIMESTAMP('2022 01 01 17:30:00','YYYY MM DD HH24:MI:SS'), 'Turbina Rt.');
INSERT INTO JARAT VALUES(1005, 0,  8, TO_TIMESTAMP('2022 01 01 12:30:00','YYYY MM DD HH24:MI:SS'), TO_TIMESTAMP('2022 01 01 17:30:00','YYYY MM DD HH24:MI:SS'), 'Turbina Rt.');
INSERT INTO JARAT VALUES(1006, 0,  9, TO_TIMESTAMP('2022 01 01 12:30:00','YYYY MM DD HH24:MI:SS'), TO_TIMESTAMP('2022 01 01 17:30:00','YYYY MM DD HH24:MI:SS'), 'Lufthansa');
INSERT INTO JARAT VALUES(1007, 0, 31, TO_TIMESTAMP('2022 01 01 12:30:00','YYYY MM DD HH24:MI:SS'), TO_TIMESTAMP('2022 01 01 17:30:00','YYYY MM DD HH24:MI:SS'), 'Lufthansa');
INSERT INTO JARAT VALUES(1008, 0, 45, TO_TIMESTAMP('2022 01 01 12:30:00','YYYY MM DD HH24:MI:SS'), TO_TIMESTAMP('2022 01 01 17:30:00','YYYY MM DD HH24:MI:SS'), 'Lufthansa');
INSERT INTO JARAT VALUES(1009, 0,  9, TO_TIMESTAMP('2022 01 01 12:30:00','YYYY MM DD HH24:MI:SS'), TO_TIMESTAMP('2022 01 01 17:30:00','YYYY MM DD HH24:MI:SS'), 'Lufthansa');
INSERT INTO JARAT VALUES(1010, 0, 78, TO_TIMESTAMP('2022 01 01 12:30:00','YYYY MM DD HH24:MI:SS'), TO_TIMESTAMP('2022 01 01 17:30:00','YYYY MM DD HH24:MI:SS'), 'Lufthansa');


--JEGYEK
INSERT INTO JEGY VALUES(1, 50000, 1, 'Admin01', 1001);
INSERT INTO JEGY VALUES(2, 60000, 1, 'Admin02', 1002);
INSERT INTO JEGY VALUES(3, 20000, 0, 'Admin03', 1003);
INSERT INTO JEGY VALUES(4, 40000, 0, 'Admin04', 1004);
INSERT INTO JEGY VALUES(5, 30000, 0, 'Admin05', 1005);
...
/*
SELECT COUNT(*) FROM BIZTOSITO;                 --5
SELECT COUNT(*) FROM BIZTOSITAS;                --100
SELECT COUNT(*) FROM BIZTOSITAS_KATEGORIAK;     --100
SELECT COUNT(*) FROM UTAS;                      --5
SELECT COUNT(*) FROM JARAT;                     --10
SELECT COUNT(*) FROM JEGY;                      --5
SELECT COUNT(*) FROM ERTEKEL;                   --10
SELECT COUNT(*) FROM LEGITARSASAG;              --5
                                                --230
*/                                                